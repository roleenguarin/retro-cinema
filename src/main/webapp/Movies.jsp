...
<html>
    <head>
        ...
        <title>Movies: Now Showing</title>
                ...
                <div id="Movies">
                    ...
                    <div class="row d-flex align-items-end" id="BannerRow">
                        <div class="d-flex flex-wrap col justify-content-start align-items-end">
                            <a href="MoviesServlet"><image src="<%= session.getAttribute("path")%>NowShowingBanner.png" id="Banner" height="60"></a>
                        </div>
                        <div class="d-flex flex-fill col-1 justify-content-start align-items-end">
                            <a href="MoviesComingSoonServlet"><image src="<%= session.getAttribute("path")%>ComingSoonBanner.png" id="Banner" height="35"></a>
                        </div>
