                    ...
                    <table id="adminMovies"> 
                        ...
                        <tr>
                            <form method="POST" action="AddMovieServlet" enctype='multipart/form-data'>
                                <td><input name="poster" type="file" class="form-control w-15"></td>
                                <td><input name="title" type="text" class="form-control">  </td>
                                <td><input name="duration" type="text" class="form-control">  </td>
                                <td><input name="release" type="text" class="form-control">  </td>
                                <td><input name="description" type="text" class="form-control">  </td>
                                <td><input name="genres" type="text" class="form-control">  </td>
                                <td><input name="director" type="text" class="form-control">  </td>
                                <td><input name="ageRating" type="text" class="form-control">  </td>
                                <td><input name="starRating" type="text" class="form-control">  </td>
                                <td><input name="status" type="text" class="form-control">  </td>
                                <td><input id="addtbl" type="submit" name="addrecord" value="Add" class="btn btn-success"></td>
                            </form>
                        </tr>
                    </table>
                </div>
