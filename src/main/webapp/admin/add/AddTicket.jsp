            ...
            <div id="center" class="d-flex col justify-content-center align-items-end">
                <div>
                    ...
                    <table id="adminTickets"> 
                        <tr id="TableHeader">
                            <th></th><!--create seat instance--><!--create show instance--><!--create sched instance-->
                            <th>Seat ID</th>
                            <th>Movie</th>
                            <th>Cinema</th>
                            <th>Date</th>
                        ...
                        <tr>
                            <form method="POST" action="AddTicketServlet">
                                <td></td>
                                <td><input name="seatid" type="text" class="form-control">  </td>
                                <td><input name="movie" type="text" class="form-control">  </td>
                                <td><input name="cinema" type="text" class="form-control">  </td>
                                <td><input name="date" type="text" class="form-control">  </td>
                                <td><input name="time" type="text" class="form-control">  </td>
                                <td><input name="payment" type="text" class="form-control">  </td>
