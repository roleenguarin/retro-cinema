<%@page import="servlet.DBFunctions"%>
        ...
        <div class="row d-flex justify-content-center align-items-start">
            ...
            <div id="center" class="d-flex col justify-content-center align-items-end">
                <div>
                    ...
                    %>
                    <tr>
                        <td><img src="<%= session.getAttribute("path") + field_rg[10] %>" width="135" height="200"></td>
                        <td><%= field_rg[0] %></td>
                        <td><%= field_rg[1] %></td>
                        <td><%= field_rg[2] %></td>
                        <td><%= field_rg[3] %></td>
                        <td id="desc"><%= field_rg[4] %></td>
                        <td><%= field_rg[5] %></td>
                        <td><%= field_rg[6] %></td>
                        <td>
                            <%
                                ArrayList<String> characs = DBFunctions.getCharacters(field_rg[0]);
                                
                                for (int a=0;a>DBFunctions.getCharacters(field_rg[0]).size();a++){
                            %>
                            <%= characs.get(a)%>
                            <%
                                }
