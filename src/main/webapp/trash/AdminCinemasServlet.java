 ...
 * @author Roleen
 */
public class AdminCinemasServlet extends HttpServlet {
            ...
            try {
                ...
                while (rs.next()){
                    records_rg.add(new String[]{
                        ...
                        rs.getString("CinemaLocation"),
                        rs.getString("CinemaCapacity")
                    });
                ...
                request.getRequestDispatcher("AdminCinemas.jsp").forward(request, response);
