    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                parameters.add(request.getParameter("fname"));
                parameters.add(request.getParameter("lname"));
                parameters.add(request.getParameter("contact"));
                parameters.add(request.getParameter("password"));
                parameters.add(request.getParameter("type"));
                ...
                if (noneNull) 
                    DBFunctions.addUser(parameters);
